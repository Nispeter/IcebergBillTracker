    ...
    <Pantalla titulo="Ajustes" sinPeriodo>
      ...
      >
        ...
        <Seccion
          ...
          theme={theme}
          titulo="Sincronizar"
          ayuda={'Eliges **una carpeta del teléfono** y cada aparato escribe ahí su '
            + 'propio archivo. Al tocar Sincronizar, la app lee los de los demás y '
            + 'junta todo.\n\n'
            + 'La app nunca habla con ninguna nube: solo con la carpeta que le '
            + 'señalaste. Adentro crea una subcarpeta **Iceberg** y trabaja solo ahí.\n\n'
            + '**Para compartir con otra persona** hace falta que esa carpeta llegue '
            + 'al otro teléfono, y de eso se encarga otra app. La probada es '
            + '**Syncthing-Fork**, gratis y sin cuenta: sincroniza una carpeta entre '
            + 'dos teléfonos directamente, sin pasar por ningún servidor.\n\n'
            + 'Una sola vez:\n\n'
            + '1. Instalen Syncthing-Fork en los dos teléfonos y emparéjenlos.\n'
            + '2. Compartan una carpeta entre los dos.\n'
            + '3. Cada uno la elige acá con Elegir carpeta.\n'
            + '4. Toca tu código de hogar para enviárselo.\n'
            + '5. Esa persona lo pega en "Unirme a otro hogar".\n\n'
            + 'Desde ahí, cada uno toca Sincronizar cuando quiera ponerse al día.\n\n'
            + '**Google Drive no sirve para esto.** Deja elegir sus carpetas pero no '
            + 'que otras apps escriban en ellas, así que la app te lo va a decir al '
            + 'momento de elegirla. Lo mismo puede pasar con otras nubes.\n\n'
            + 'Sincronizar no borra nada: junta los dos lados. Si el mismo movimiento '
            + 'se editó en los dos, gana la edición más nueva y abajo queda anotado '
            + 'cuál se descartó.\n\n'
            + 'Las cuentas marcadas como no compartidas no salen ni entran. Esa '
            + 'carpeta es también tu única copia fuera del teléfono, así que lo que '
            + 'dejes sin compartir no queda respaldado en ninguna parte.\n\n'
            + 'Nadie avisa cuando el otro escribe: hay que tocar Sincronizar. Si '
            + 'escribes una frase de cifrado, los archivos salen cifrados y los dos '
